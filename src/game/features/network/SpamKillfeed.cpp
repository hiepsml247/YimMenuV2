...
namespace YimMenu::Features
{
	...
	static SpamKillfeed _SpamKillfeed{"spamkillfeed", "Spam bảng thông báo hạ gục", "Liên tục gửi thông báo hạ gục giả lên bảng của tất cả người chơi. Hãy cân nhắc khi sử dụng."};
}