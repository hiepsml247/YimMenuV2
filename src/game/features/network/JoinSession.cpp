...
namespace YimMenu::Features
{
	...
	static ListCommand _JoinType{"joinsessiontype", "Chọn loại phòng tham gia", "Loại phòng bạn muốn vào", g_JoinTypes, static_cast<int>(Network::JoinType::JOIN_PUBLIC)};
	...
	static JoinSession _JoinSession{"joinsession", "Tham gia phòng", "Vào loại phòng đã chọn"};
